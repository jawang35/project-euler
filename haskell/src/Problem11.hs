...
largestProductInGrid :: [[Int]] -> Int
largestProductInGrid grid =
    maximum [a, b, c, d]
    where a = largestHorizontalProductInGrid grid
          b = largestVerticalProductInGrid grid
          c = largestDiagonalProductInGrid grid
          d = largestInverseDiagonalProductInGrid grid
